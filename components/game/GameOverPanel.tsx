...
export default function GameOverPanel({ gameState }: GameOverPanelProps) {
  ...
  return (
    <motion.div
      ...
      animate="visible"
      exit="exit"
      className="felt-surface rounded-lg shadow-2xl p-4 sm:p-6 border-2 border-casino-gold"
    >
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="bg-casino-dark-bg/80 border border-casino-gold-dark rounded-lg p-3 sm:p-4 mb-4 sm:mb-6"
      >
        {gameState.players
          .slice()
